...
7. **开工前必须读 design 文档（即使以前读过）**
   每次启动 Claude、每次开始新任务前，必须先读 `docs/design/` 下的设计文档：
   - `prototype-redesign.html` —— 交互原型与产品形态
   - `technical-design.html` —— 架构、数据模型、分期路线
   - `功能拆解-逻辑与可信度.md` —— 每个功能的可信度
